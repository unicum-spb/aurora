...
import { Route, RouteRecord, RouteConfig } from 'vue-router/types'
...
export default class extends Vue {
  ...
  private affixTags: Array<ITagView> = []
  ...
  private onVisibleChange(value: boolean) {
    ...
    document.body[method]('click', this.closeMenu)
  }
  ...
  private async moveToCurrentTag() {
